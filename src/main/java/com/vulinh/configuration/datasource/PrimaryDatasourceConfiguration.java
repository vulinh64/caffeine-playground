...
@EnableJpaRepositories(
    ...
    entityManagerFactoryRef =
        PrimaryDatasourceConfiguration.PERSISTENCE_UNIT + DataSourceProperty.ENTITY_MANAGER,
    transactionManagerRef =
        PrimaryDatasourceConfiguration.PERSISTENCE_UNIT + DataSourceProperty.TRANSACTION_MANAGER)
